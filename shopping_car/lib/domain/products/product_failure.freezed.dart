...
class _$_InsufficientPermission implements _InsufficientPermission {
  ...
  @override
  String toString() {
    return 'ProductFailure.insufficientPermission()';
  }
...
abstract class _InsufficientPermission implements ProductFailure {
...
abstract class _UnableToUpdate implements ProductFailure {
